...
def main():    
    ...
    print(caseTest)
    pam = NondegenerateBases("nGg", case = 'upper')
    print(str(len(pam)))  #Testing our __len__ overload
    print(pam[2])  #Testing our __getitem__ overload
    for possibility in pam:  #Testing our __iter__ overload
        print(possibility)
    print(pam)  #Testing our overloaded and overridden __str__ method
